/ip dns static
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=ads-twitter.com
...
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twitpic.com
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twitter.biz
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twitter.com
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twitter.map.fastly.net
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twittercommunity.com
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twitterflightschool.com
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twitterinc.com
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twitteroauth.com
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twitterstat.us
add address-list=BlackList_RU forward-to=Google comment=twitter match-subdomain=yes type=FWD name=twtrdns.net
