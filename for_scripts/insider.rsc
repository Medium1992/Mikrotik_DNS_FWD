...
:if ([:len [/ip dns static find name="businessinsider.jp"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="insider" match-subdomain=yes type=FWD name="businessinsider.jp" }
:if ([:len [/ip dns static find name="businessinsider.nl"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="insider" match-subdomain=yes type=FWD name="businessinsider.nl" }
