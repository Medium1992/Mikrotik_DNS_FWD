...
:if ([:len [find name="tap30.services"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-ir" match-subdomain=yes type=FWD name="tap30.services" }
:if ([:len [find name="tap33.me"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-ir" match-subdomain=yes type=FWD name="tap33.me" }
:if ([:len [find name="tapsi.cab"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-ir" match-subdomain=yes type=FWD name="tapsi.cab" }
...
:if ([:len [find name="tipaxco.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-ir" match-subdomain=yes type=FWD name="tipaxco.com" }
...
:if ([:len [find name="vandar.app"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-ir" match-subdomain=yes type=FWD name="vandar.app" }
:if ([:len [find name="vandar.io"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-ir" match-subdomain=yes type=FWD name="vandar.io" }
