...
:if ([:len [find name="gspe1-ssl.ls.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="apple-intelligence" type=FWD name="gspe1-ssl.ls.apple.com" }
