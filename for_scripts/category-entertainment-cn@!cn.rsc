...
:if ([:len [find name="taptap.io"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment-cn@!cn" match-subdomain=yes type=FWD name="taptap.io" }
