...
:if ([:len [/ip dns static find name="rutracker.nl"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="rutracker" match-subdomain=yes type=FWD name="rutracker.nl" }
