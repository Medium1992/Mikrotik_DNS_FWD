...
:global ForwardTo
/ip dns static
:if ([:len [find name="dynafleetonline.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="dynafleetonline.com" }
:if ([:len [find name="escandinavia-arg.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="escandinavia-arg.com" }
:if ([:len [find name="independentoperatorcn.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="independentoperatorcn.com" }
:if ([:len [find name="road-crew.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="road-crew.com" }
:if ([:len [find name="udfs.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="udfs.com" }
...
:if ([:len [find name="vfsco.se"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="vfsco.se" }
:if ([:len [find name="vfsco.us"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="vfsco.us" }
:if ([:len [find name="vgcareers.net"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="vgcareers.net" }
:if ([:len [find name="volvo"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvo" }
:if ([:len [find name="volvo-truck.nl"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvo-truck.nl" }
:if ([:len [find name="volvo.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvo.com" }
:if ([:len [find name="volvo.se"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvo.se" }
:if ([:len [find name="volvobrandshop.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvobrandshop.com" }
:if ([:len [find name="volvobuses.be"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvobuses.be" }
...
:if ([:len [find name="volvoce.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvoce.com" }
...
:if ([:len [find name="volvogroup.se"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvogroup.se" }
...
:if ([:len [find name="volvospares.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvospares.com" }
:if ([:len [find name="volvotruckcenter.be"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvotruckcenter.be" }
:if ([:len [find name="volvotruckcenter.nl"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvotruckcenter.nl" }
:if ([:len [find name="volvotruckcenter.se"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvotruckcenter.se" }
:if ([:len [find name="volvotruckrental.be"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvotruckrental.be" }
:if ([:len [find name="volvotrucks.be"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvotrucks.be" }
...
:if ([:len [find name="volvotrucks.ps"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvotrucks.ps" }
:if ([:len [find name="volvotrucks.ru"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvotrucks.ru" }
:if ([:len [find name="volvotrucks.se"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="volvo" match-subdomain=yes type=FWD name="volvotrucks.se" }
