...
:if ([:len [find name="mradx.net"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="vk" match-subdomain=yes type=FWD name="mradx.net" }
...
:if ([:len [find name="vk-apps.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="vk" match-subdomain=yes type=FWD name="vk-apps.com" }
:if ([:len [find name="vk-apps.ru"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="vk" match-subdomain=yes type=FWD name="vk-apps.ru" }
...
:if ([:len [find name="vk.company"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="vk" match-subdomain=yes type=FWD name="vk.company" }
...
:if ([:len [find name="vk.team"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="vk" match-subdomain=yes type=FWD name="vk.team" }
...
:if ([:len [find name="vkgo.app"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="vk" match-subdomain=yes type=FWD name="vkgo.app" }
:if ([:len [find name="vklive.app"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="vk" match-subdomain=yes type=FWD name="vklive.app" }
...
:if ([:len [find name="vkvideo.ru"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="vk" match-subdomain=yes type=FWD name="vkvideo.ru" }
