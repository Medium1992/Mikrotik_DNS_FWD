...
:if ([:len [find name="assp.sohu.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="sohu-ads" match-subdomain=yes type=FWD name="assp.sohu.com" }
...
:if ([:len [find name="imp.go.sohu.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="sohu-ads" match-subdomain=yes type=FWD name="imp.go.sohu.com" }
...
:if ([:len [find name="lu.sogou.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="sohu-ads" match-subdomain=yes type=FWD name="lu.sogou.com" }
...
:if ([:len [find name="m.aty.sohu.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="sohu-ads" match-subdomain=yes type=FWD name="m.aty.sohu.com" }
:if ([:len [find name="p.aty.sohu.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="sohu-ads" match-subdomain=yes type=FWD name="p.aty.sohu.com" }
:if ([:len [find name="pb.i.sogou.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="sohu-ads" match-subdomain=yes type=FWD name="pb.i.sogou.com" }
:if ([:len [find name="pv.hd.sohu.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="sohu-ads" match-subdomain=yes type=FWD name="pv.hd.sohu.com" }
...
:if ([:len [find name="reke.at.sohu.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="sohu-ads" match-subdomain=yes type=FWD name="reke.at.sohu.com" }
...
:if ([:len [find name="wuliao.epro.sogou.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="sohu-ads" match-subdomain=yes type=FWD name="wuliao.epro.sogou.com" }
