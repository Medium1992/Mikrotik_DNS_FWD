...
:if ([:len [/ip dns static find name="scholar.google.co.jp"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-scholar" type=FWD name="scholar.google.co.jp" }
...
:if ([:len [/ip dns static find name="scholar.google.com.tw"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-scholar" type=FWD name="scholar.google.com.tw" }
:if ([:len [/ip dns static find name="scholar.google.nl"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-scholar" type=FWD name="scholar.google.nl" }
...
:if ([:len [/ip dns static find name="scholar.google.se"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-scholar" type=FWD name="scholar.google.se" }
