...
add forward-to=fakeipRU comment=whatsapp match-subdomain=yes type=FWD name=whatsapp.info
add forward-to=fakeipRU comment=whatsapp match-subdomain=yes type=FWD name=whatsapp.net
add forward-to=fakeipRU comment=whatsapp match-subdomain=yes type=FWD name=whatsapp.org
add forward-to=fakeipRU comment=whatsapp match-subdomain=yes type=FWD name=whatsapp.tv
add forward-to=fakeipRU comment=whatsapp match-subdomain=yes type=FWD name=whatsappbrand.com
