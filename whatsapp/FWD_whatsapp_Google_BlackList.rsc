...
add address-list=BlackList forward-to=Google comment=whatsapp match-subdomain=yes type=FWD name=whatsapp.info
add address-list=BlackList forward-to=Google comment=whatsapp match-subdomain=yes type=FWD name=whatsapp.net
add address-list=BlackList forward-to=Google comment=whatsapp match-subdomain=yes type=FWD name=whatsapp.org
add address-list=BlackList forward-to=Google comment=whatsapp match-subdomain=yes type=FWD name=whatsapp.tv
add address-list=BlackList forward-to=Google comment=whatsapp match-subdomain=yes type=FWD name=whatsappbrand.com
