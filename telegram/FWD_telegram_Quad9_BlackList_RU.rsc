/ip dns static
add address-list=BlackList_RU forward-to=Quad9 comment=telegram match-subdomain=yes type=FWD name=cdn-telegram.org
add address-list=BlackList_RU forward-to=Quad9 comment=telegram match-subdomain=yes type=FWD name=comments.app
add address-list=BlackList_RU forward-to=Quad9 comment=telegram match-subdomain=yes type=FWD name=contest.com
