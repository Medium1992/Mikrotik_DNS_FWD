/ip dns static
add forward-to=fakeipRU comment=telegram match-subdomain=yes type=FWD name=cdn-telegram.org
add forward-to=fakeipRU comment=telegram match-subdomain=yes type=FWD name=comments.app
add forward-to=fakeipRU comment=telegram match-subdomain=yes type=FWD name=contest.com
