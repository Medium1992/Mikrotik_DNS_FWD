/ip dns static
add address-list=BlackList forward-to=OwnDNS comment=samsung match-subdomain=yes type=FWD name=galaxyappstore.com
add address-list=BlackList forward-to=OwnDNS comment=samsung match-subdomain=yes type=FWD name=game-platform.net
add address-list=BlackList forward-to=OwnDNS comment=samsung match-subdomain=yes type=FWD name=knoxemm.com
add address-list=BlackList forward-to=OwnDNS comment=samsung match-subdomain=yes type=FWD name=samsung
add address-list=BlackList forward-to=OwnDNS comment=samsung match-subdomain=yes type=FWD name=samsung.com
